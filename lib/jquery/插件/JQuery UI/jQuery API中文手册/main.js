jqapi = function () {
    ...
    function formatArticle() {
        var pDesc = $('http://www.css88.com/jquery-ui-api/js/p.desc', elements.content);
    ...
    function buildDemos() {
        $( ".entry-example" ).each(function() {
            		...
            		iframeSrc = src.find( "http://www.css88.com/jquery-ui-api/js/td.code .line" ).map(function() {
...
$(document).ready(function () {
    /*var navigation_el = $('#navigation').load('http://www.css88.com/jquery-ui-api/js/navigation.html', function () { //load the navigation (not static because it gets generated with the api scraping)
